...
//Try for Transfering chunks of Data
grpc::Status WorkerImplGRPCSync::Transfer(::grpc::ServerContext *context,
                                          const ::distributed::StoredData *request,
                                          ::grpc::ServerWriter<::distributed::Data> *writer)
{
    ...
    // Initialize DaphneSerializerChunks with the object and default chunk size
    DaphneSerializerChunks<Structure> serializer(mat);
